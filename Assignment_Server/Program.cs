using Assignment_Server.Controllers;
...
builder.Services.AddScoped<ImageUploadController>();
...
{
    // Yêu cầu password phải có ít nhất 5 kí tự ( 1 kí tự in hoa, 1 kí tự thường, 1 số )
...
{
    options.Authority = builder.Configuration["Auth0:Audience"];
